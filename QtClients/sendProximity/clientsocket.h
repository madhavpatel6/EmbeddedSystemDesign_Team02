...
signals:
    ...
    void sendAlignmentSignal(char source, QString alignmentData0, QString alignmentData1, QString alignmentData2, QString alignmentBool_0, QString alignmentBool_1, QString alignmentBool_2, QString alignmentGrabberBool, QString alignmentInfo);
public slots:
    void connected();
    void disconnected();
    void readyRead();
