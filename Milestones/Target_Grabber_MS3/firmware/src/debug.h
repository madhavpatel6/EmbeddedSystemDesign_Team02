...
enum LocationEnum {
    ...
    ENTER_COMPUTATION_THREAD = 40,                                  // 40
    BEFORE_WHILE_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD,          // 41
    BEFORE_SEND_TO_Q_COMPUTATION_THREAD,                            // 42
    BEFORE_RECEIVE_FROM_Q_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD, // 43
    AFTER_CMVALCHECKER_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD,    // 44
    AFTER_BOOLEAN_IFS_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD,     // 45
    BEFORE_SWITCH_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD,         // 46
    AFTER_SWITCH_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD,          // 47
    
    AFTER_SEND_TO_Q_COMPUTATION_THREAD,                             // 48
    AFTER_RECEIVE_FROM_Q_TARGET_ALIGNMENT_SUBR_COMPUTATION_THREAD,  // 49
    ENTER_CONVERTTOCM_COMPUTATION_THREAD,                           // 50
    LEAVE_CONVERTTOCM_COMPUTATION_THREAD,                           // 51
    ENTER_DETERMINEALIGNMENT_COMPUTATION_THREAD,                    // 52
    LEAVE_DETERMINEALIGNMENT_COMPUTATION_THREAD,                    // 53
    
    // COMPUTATION THREAD STATES
    INIT_STATE_COMPUTATION_THREAD,                                  // 54
    REQUEST_TARGET_PROXIMITY_STATE_COMPUTATION_THREAD,              // 55
    TARGET_ALIGNMENT_STATE_COMPUTATION_THREAD,                      // 56
    TARGET_ACQUIRE_STATE_COMPUTATION_THREAD,                        // 57
    REQUEST_OUTSIDE_OF_ARENA_STATE_COMPUTATION_THREAD,              // 58
    TARGET_DROP_STATE_COMPUTATION_THREAD,                           // 59
    ...
    BEFORE_SWITCH_TMR_INSTANCE_1_ISR,     // 141
    BEFORE_SEND_TO_Q_TMR_INSTANCE_1_ISR,  // 142
    SMTOTL_TMR_INSTANCE_1_ISR,            // 143
    TLTOSM_TMR_INSTANCE_1_ISR,            // 144
    TLTOPF_TMR_INSTANCE_1_ISR,            // 145
    PFTOTL_TMR_INSTANCE_1_ISR,            // 146
    PFTOTG_TMR_INSTANCE_1_ISR,            // 147
    TGTOPF_TMR_INSTANCE_1_ISR,            // 148
    AFTER_SEND_TO_Q_TMR_INSTANCE_1_ISR,   // 149
    LEAVE_TMR_INSTANCE_1_ISR,             // 150
