...
static void _MOTOR_CONTROLLER_THREAD_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for MOTOR_CONTROLLER_THREAD Tasks. */
    xTaskCreate((TaskFunction_t) _MOTOR_CONTROLLER_THREAD_Tasks,
                "MOTOR_CONTROLLER_THREAD Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _MOTOR_CONTROLLER_THREAD_Tasks ( void )

  Summary:
    Maintains state machine of MOTOR_CONTROLLER_THREAD.
*/
