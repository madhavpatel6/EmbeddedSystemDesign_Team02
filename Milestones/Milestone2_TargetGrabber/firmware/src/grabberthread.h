...
typedef enum
{
	...
	GRABBERTHREAD_STATE_INIT=0,
	GRABBERTHREAD_STATE_SERVICE_TASKS,

	/* TODO: Define states used by the application state machine. */

} GRABBERTHREAD_STATES;
...
typedef struct
{
	QueueHandle_t grabber_ISR_Q;
    
} GRABBER_ISR_DATA;

typedef struct
{
	QueueHandle_t grabber_CMD_Q;
