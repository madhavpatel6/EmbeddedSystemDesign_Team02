...
typedef enum {CommStatsSearcherMover, CommStatsTargetLocator, CommStatsPathFinder, CommStatsTargetGrabber,
       ...
       DetailedCommStatsTargetGrabber, SensorData, msLocalTime, targetAlignment, targetAcquired } items_t; 
       
typedef enum {targetProximity, outsideArena, movementStopped } pathFinderResponse_t;
