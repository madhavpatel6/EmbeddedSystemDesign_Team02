...
/*scan enable*/
    /* Select Scan Input 0,1,2,3,4 */
     PLIB_ADC_InputScanMaskAdd(DRV_ADC_ID_1, ADC_INPUT_SCAN_AN0 | ADC_INPUT_SCAN_AN1 | ADC_INPUT_SCAN_AN2| ADC_INPUT_SCAN_AN3| ADC_INPUT_SCAN_AN4);
