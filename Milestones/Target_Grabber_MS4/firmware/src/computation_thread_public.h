...
// This struct contains the five IR sensor values in uint32_t because
// that is what the adc outputs
// Also contains the responses from the PathFinder: int and bool
typedef struct {
    uint32_t IR_0;
    uint32_t IR_1;
    uint32_t IR_2;
    uint32_t IR_3;
    uint32_t IR_4;
    int targetProximityInt;
    bool outsideArenaBool;
    bool movementStoppedBool;
